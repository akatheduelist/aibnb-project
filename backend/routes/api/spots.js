...
const validateNewSpot = [
	...
	check("lat").exists({checkFalsy: true}).isDecimal({force_decimal: true}).withMessage("Latitude is not valid"),
	check("lng").exists({checkFalsy: true}).isDecimal({force_decimal: true}).withMessage("Longitude is not valid"),
...
const validateNewBooking = [
	check("startDate").exists({checkFalsy: true}).withMessage("Start date is required").isDate(),
	check("endDate")
...
router.post("/:spotId/bookings", [requireAuth, validateNewBooking], async (req, res, next) => {
...
const validateQueryFilters = [
	...
	check("maxLat").optional().isInt().withMessage("Maximum latitude is invalid"),
	check("minLat").optional().isInt().withMessage("Minimum latitude is invalid"),
	check("minLng").optional().isInt().withMessage("Maximum longitude is invalid"),
	check("maxLng").optional().isInt().withMessage("Maximum longitude is invalid"),
